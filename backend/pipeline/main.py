...
if __name__ == "__main__":
    ...
    try:
        while True:
            ...
            try:
                future_depth = executor.submit(run_depth_estimation, MIDAS, TRANSFORM, rgb_frame_copy, device, stream_depth)
                future_objects = executor.submit(run_object_detection, YOLO, undistorted_frame, device, stream_objdet)
